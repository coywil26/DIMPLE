...
parser.add_argument('-DIS', action='store_const', const=True, help='Run deep insertion scan')
parser.add_argument('-DMS', action='store_const', const=True, help='Run deep mutation scan')
